  ...
  return (
    <div data-testid="admin-student-details">
      ...
      <div className="mb-6 flex gap-3">
        <Button color="blue" onClick={() => navigate(`/admin/classes/${classId}/students/${studentId}/scores`)} data-testid="view-scores-link">
          View Recent Tests →
        </Button>
        <Button color="gray" onClick={() => navigate(`/admin/classes/${classId}/students/${studentId}/reports`)} data-testid="view-reports-link">
          View Reports →
        </Button>
      </div>
